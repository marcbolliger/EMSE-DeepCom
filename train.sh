...
python3 $source/data_utils/get_ast.py $model/train/train_p.token.code $model/train/train_p.token.nl $model/train/train.token.code $model/train/train.token.nl $model/train/train.token.ast
